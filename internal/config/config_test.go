...
func TestCanGetConfigFromFile(t *testing.T) {
	...
	assert.Equal(t, 3, cfg.GetLayer("github.com/gennadyterekhov/import-layers-go/internal/finalizer"))

	assert.Equal(t, 2, cfg.GetLayer("github.com/gennadyterekhov/import-layers-go/examples/basic/high"))
	assert.Equal(t, 1, cfg.GetLayer("github.com/gennadyterekhov/import-layers-go/examples/basic/low"))
}
